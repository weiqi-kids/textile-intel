...
class ShenzhouFetcher(CompanyFetcher):
    """申洲國際 爬蟲"""

    company_id = "shenzhou"
    company_name = "申洲國際"
    news_url = "https://www.申洲國際.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 申洲國際")
        return documents
