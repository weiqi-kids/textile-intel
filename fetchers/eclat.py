...
class EclatFetcher(CompanyFetcher):
    """儒鴻企業 爬蟲"""

    company_id = "eclat"
    company_name = "儒鴻企業"
    news_url = "https://www.儒鴻企業.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 儒鴻企業")
        return documents
