...
class VfCorpFetcher(CompanyFetcher):
    """VF Corporation 爬蟲"""

    company_id = "vf_corp"
    company_name = "VF Corporation"
    news_url = "https://www.vfcorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.vfcorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from VF Corporation")
        return documents
