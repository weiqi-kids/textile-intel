...
class MakalotFetcher(CompanyFetcher):
    """聚陽實業 爬蟲"""

    company_id = "makalot"
    company_name = "聚陽實業"
    news_url = "https://www.聚陽實業.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 聚陽實業")
        return documents
