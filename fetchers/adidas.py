...
class AdidasFetcher(CompanyFetcher):
    """Adidas AG 爬蟲"""

    company_id = "adidas"
    company_name = "Adidas AG"
    news_url = "https://www.adidasag.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.adidasag.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Adidas AG")
        return documents
