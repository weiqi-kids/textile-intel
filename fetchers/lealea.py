...
class LealeaFetcher(CompanyFetcher):
    """力麗集團 爬蟲"""

    company_id = "lealea"
    company_name = "力麗集團"
    news_url = "https://www.力麗集團.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 力麗集團")
        return documents
