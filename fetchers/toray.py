...
class TorayFetcher(CompanyFetcher):
    """Toray Industries 爬蟲"""

    company_id = "toray"
    company_name = "Toray Industries"
    news_url = "https://www.torayindustries.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.torayindustries.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Toray Industries")
        return documents
