...
class TapestryFetcher(CompanyFetcher):
    """Tapestry 爬蟲"""

    company_id = "tapestry"
    company_name = "Tapestry"
    news_url = "https://www.tapestry.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tapestry.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Tapestry")
        return documents
