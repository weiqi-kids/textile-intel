...
class LenzingFetcher(CompanyFetcher):
    """Lenzing AG 爬蟲"""

    company_id = "lenzing"
    company_name = "Lenzing AG"
    news_url = "https://www.lenzingag.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lenzingag.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Lenzing AG")
        return documents
