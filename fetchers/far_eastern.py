...
class FarEasternFetcher(CompanyFetcher):
    """遠東新世紀 爬蟲"""

    company_id = "far_eastern"
    company_name = "遠東新世紀"
    news_url = "https://www.遠東新世紀.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 遠東新世紀")
        return documents
