...
class FormosaTaffetaFetcher(CompanyFetcher):
    """南紡 爬蟲"""

    company_id = "formosa_taffeta"
    company_name = "南紡"
    news_url = "https://www.南紡.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 南紡")
        return documents
