...
class FastRetailingFetcher(CompanyFetcher):
    """迅銷集團 爬蟲"""

    company_id = "fast_retailing"
    company_name = "迅銷集團"
    news_url = "https://www.迅銷集團.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 迅銷集團")
        return documents
