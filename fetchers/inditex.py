...
class InditexFetcher(CompanyFetcher):
    """Inditex 爬蟲"""

    company_id = "inditex"
    company_name = "Inditex"
    news_url = "https://www.inditex.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Inditex")
        return documents
