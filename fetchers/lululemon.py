...
class LululemonFetcher(CompanyFetcher):
    """Lululemon Athletica 爬蟲"""

    company_id = "lululemon"
    company_name = "Lululemon Athletica"
    news_url = "https://www.lululemonathletica.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lululemonathletica.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Lululemon Athletica")
        return documents
